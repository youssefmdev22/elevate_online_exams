...
abstract interface class AuthOnlineDataSource {
  ...
  Future<ApiResult<VerifyResetCodeModel>> verifyResetCode(VerifyResetCodeRequestModel verifyResetCodeRequestModel,
  );

  Future<ApiResult<ResetPasswordModel>> resetPassword(ResetPasswordRequestModel resetPasswordRequestModel,
  );
}
